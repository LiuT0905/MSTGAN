...
# ---------------------------
# PM encoder (Utilizing 1D Conv at Bottleneck)
# ---------------------------
class PMEncoder(nn.Module):
    ...
    def forward(self, pm_seq, cp_layer):
        ...
        x4 = self.down3(x3)  # [B, 512, H_b, W_b]
...
def main():
    ...
    parser.add_argument('--mask_path', default=r"D:\MMSTGAN\mask\mask_huabei.txt")
    parser.add_argument('--outf', default=r"D:\MMSTGAN\experiment\nt1")
