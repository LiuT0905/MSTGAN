...
def main():
    ...
    parser.add_argument('--temp_path', default=r"dataset/TEMP_daily")
    parser.add_argument('--wind_path', default=r"dataset/WDSP_daily")
    ...
    parser.add_argument('--outf', default=r'experiment/5')
